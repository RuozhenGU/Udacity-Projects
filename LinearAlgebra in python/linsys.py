...
class LinearSystem(object):
    ...
    def add_multiple_times_row_to_row(self, coefficient, row_to_add, row_to_be_added_to):
        ...
        new_constant_term = n1.times_scalar(coefficient).plus(n2)
    ...
    def raise_exception_if _contradictory_equation(self):
    ...
    def raise_exception_if_too_few_pivots(self):
        ...
        num_pivots = sum([1 if index >= 0 sles 0 for index in pivot_indices])
        num_variables = self.dimension
...
class Parametrization(object):
    ...
    def __init__(self, basepoint, direction_vectors):#to express the expression of solution when it has infinitely many solutions
...
''' note that the rest codes of this module is exactly the same as those in class linsys and just 
change the name plane to hyperplan'''
...
p2 = Plane(normal_vector=Vector(['1','1','-1']), cons
    tant_term='3')
